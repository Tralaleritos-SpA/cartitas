              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (error.lastName) clearFieldError("lastName");
                  }}
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (error.rpassword) clearFieldError("rpassword");
                  }}
                  placeholder="Reingresa tu contraseña"
                  required
                  disabled={loading}
                />
                {error.rpassword && <div className="invalid-feedback">{error.rpassword}</div>}
              </div>
